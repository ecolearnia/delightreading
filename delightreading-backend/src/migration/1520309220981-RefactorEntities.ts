...
export class RefactorEntities1520309220981 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "activity_log" ("sid" SERIAL NOT NULL, "uid" character varying(80) NOT NULL, "status" character varying(12), "createdat" TIMESTAMP, "createdBy" bigint, "updatedAt" TIMESTAMP, "updatedBy" bigint, "accountSid" bigint NOT NULL, "referenceSid" bigint NOT NULL, "referencingLogSid" bigint, "goalSid" bigint, "activity" character varying(64) NOT NULL, "logTimestamp" TIMESTAMP NOT NULL, "quantity" numeric(6,3) NOT NULL, "postEmotion" text, "situation" text, "feedContext" character varying(256), "feedBody" text, "retrospective" text, PRIMARY KEY("sid"))`);
        await queryRunner.query(`CREATE TABLE "goal" ("sid" SERIAL NOT NULL, "uid" character varying(80) NOT NULL, "status" character varying(12), "createdat" TIMESTAMP, "createdBy" bigint, "updatedAt" TIMESTAMP, "updatedBy" bigint, "accountSid" bigint NOT NULL, "title" character varying(256) NOT NULL, "activity" character varying(64) NOT NULL, "startDate" date NOT NULL, "endDate" date NOT NULL, "actualCompletionDate" date, "quantity" numeric(6,3) NOT NULL, "quantityUnit" character varying(64) NOT NULL, "timePeriod" character varying(127), "retrospective" text, PRIMARY KEY("sid"))`);
        await queryRunner.query(`CREATE TABLE "reference" ("sid" SERIAL NOT NULL, "uid" character varying(80) NOT NULL, "status" character varying(12), "createdat" TIMESTAMP, "createdBy" bigint, "updatedAt" TIMESTAMP, "updatedBy" bigint, "sourceUri" character varying(256), "title" character varying(128) NOT NULL, "authors" character varying(128), "publisher" character varying(128), "publishedDate" character varying(12), "description" text, "synopsys" text, "identifiers" json, "pageCount" integer, "categories" json, "averageRating" numeric(3,1), "ratingsCount" integer, "maturityRating" character varying(64), "language" character varying(6), "imageUrl" character varying(350), "thumbnailImageUrl" character varying(350), "awards" json, PRIMARY KEY("sid"))`);
