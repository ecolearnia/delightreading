...
export class RefactorEntities1518130317033 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "activity_log" ("sid" SERIAL NOT NULL, "uid" character varying(80) NOT NULL, "status" character varying(12), "createdat" TIMESTAMP, "createdBy" bigint, "updatedAt" TIMESTAMP, "updatedBy" bigint, "accountSid" bigint NOT NULL, "goalSid" bigint NOT NULL, "activity" character varying(64) NOT NULL, "logTimestamp" TIMESTAMP NOT NULL, "quantity" numeric(6,3) NOT NULL, "situation" text, "feedContext" character varying(256), "feedBody" text, "referenceTitle" character varying(256), "referencingLogSid" bigint, PRIMARY KEY("sid"))`);
